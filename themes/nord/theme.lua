...
theme.nord0  = colorlib.hsl2hex(220,   16.4, 21.6) or '#2E3440' -- Polar Night 1
theme.nord1  = colorlib.hsl2hex(221.7, 16.3, 27.6) or '#3B4252' -- Polar Night 2
theme.nord2  = colorlib.hsl2hex(220,   16.8, 31.6) or '#434C5E' -- Polar Night 3
theme.nord3  = colorlib.hsl2hex(220,   16.5, 35.7) or '#4C566A' -- Polar Night 4
theme.nord4  = colorlib.hsl2hex(218.8, 27.9, 88  ) or '#D8DEE9' -- Snow Storm 1
theme.nord5  = colorlib.hsl2hex(218.2, 26.8, 92  ) or '#E5E9F0' -- Snow Storm 2
theme.nord6  = colorlib.hsl2hex(217.5, 26.7, 94.1) or '#ECEFF4' -- Snow Storm 3
theme.nord7  = colorlib.hsl2hex(178.7, 25.1, 64.9) or '#8FBCBB' -- Frost 1
theme.nord8  = colorlib.hsl2hex(193.3, 43.4, 67.5) or '#88C0D0' -- Frost 2
theme.nord9  = colorlib.hsl2hex(210,   34,   63.1) or '#81A1C1' -- Frost 3
theme.nord10 = colorlib.hsl2hex(213.1, 32,   52.2) or '#5E81AC' -- Frost 4
theme.nord11 = colorlib.hsl2hex(354.3, 42.3, 56.5) or '#BF616A' -- Aurora 1
theme.nord12 = colorlib.hsl2hex(14.4,  50.5, 62.7) or '#D08770' -- Aurora 2
theme.nord13 = colorlib.hsl2hex(40,    70.6, 73.3) or '#EBCB8B' -- Aurora 3
theme.nord14 = colorlib.hsl2hex(92.4,  27.8, 64.7) or '#A3BE8C' -- Aurora 4
theme.nord15 = colorlib.hsl2hex(311.1, 20.2, 63.1) or '#B48EAD' -- Aurora 5
